...
""";
      ...
      <html lang="en">
        <head>
          ...
          <style>
          @font-face { font-family: "amiriQuran"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[amiriQuranFont]}) format("truetype"); }
          @font-face { font-family: "kitab"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[kitabFont]}) format("truetype"); }
          @font-face { font-family: "lateef"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[lateefFont]}) format("truetype"); }
          @font-face { font-family: "meQuran"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[meQuranFont]}) format("truetype"); }
          @font-face { font-family: "noorehidayat"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[noorehidayatFont]}) format("truetype"); }
          @font-face { font-family: "noorehira"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[noorehiraFont]}) format("truetype"); }
          @font-face { font-family: "noorehuda"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[noorehudaFont]}) format("truetype"); }
          @font-face { font-family: "qalam"; src: url(data:font/truetype;charset=utf-8;base64,${base64Fonts[qalamFont]}) format("truetype"); }
      
          :root {
            --arabic-font-size: ${appInfoProvider.arabicTextSize}px;
          }
          :root {
            --arabic-font-family: ${appInfoProvider.arabicFont};
          }
          :root {
