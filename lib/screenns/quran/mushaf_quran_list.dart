...
import 'package:al_quran/widgets/quran/mushaf_quran_list_item.dart';
import 'package:al_quran/widgets/quran/search_surah.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';

class MushafQuranList extends StatefulWidget {
  const MushafQuranList({super.key});

  @override
  State<MushafQuranList> createState() => _MushafQuranListState();
}

class _MushafQuranListState extends State<MushafQuranList> {
  String inputText = "";
