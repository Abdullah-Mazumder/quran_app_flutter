...
String amiriQuranFont = 'amiriQuran';
String kitabFont = 'kitab';
String lateefFont = 'lateef';
String meQuranFont = 'meQuran';
String noorehidayatFont = 'noorehidayat';
String noorehiraFont = 'noorehira';
String noorehudaFont = 'noorehuda';
String qalamFont = 'qalam';
...
final List<DropdownItem> fonts = [
  DropdownItem(
      value: 'amiriQuran', labelBn: "আমীরী কুরআন", labelEn: "Amiri Quran"),
  DropdownItem(value: 'kitab', labelBn: "কিতাব", labelEn: "Kitab"),
  DropdownItem(value: 'lateef', labelBn: "লতীফ", labelEn: "Lateef"),
  DropdownItem(value: 'meQuran', labelBn: "কুরআন মি", labelEn: "Quran Me"),
  DropdownItem(
      value: 'noorehidayat', labelBn: "নূরে হিদায়াত", labelEn: "Noore Hidayat"),
  DropdownItem(value: 'noorehira', labelBn: "নূরে হিরা", labelEn: "Noore Hira"),
  DropdownItem(value: 'noorehuda', labelBn: "নূরে হুদা", labelEn: "Noore Huda"),
  DropdownItem(value: 'qalam', labelBn: "কালাম", labelEn: "Qalam"),
];
